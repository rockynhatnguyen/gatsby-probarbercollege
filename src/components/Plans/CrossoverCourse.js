    ...
    return (
        <div className="max-w-7xl mx-4 md:mx-auto flex flex-col items-center md:flex-row md:justify-center md:items-start mt-16">
            <div className="w-full md:w-1/3 flex flex-col items-start justify-start pr-0 md:pr-10 pt-10 md:pb-10">
                ...
                <div className="w-full block">
                    <StaticImage className="w-full rounded-2xl"
                        src="../../images/plans-crossover-1.jpg"
                        width={500}
                        quality={95}
                ...
                <div className="w-full hidden md:block">
                    <StaticImage className="w-full rounded-2xl"
                        src="../../images/plans-crossover-2.jpg"
                        width={500}
                        quality={95}
                        formats={["AUTO", "WEBP", "AVIF"]}
                        alt="A barber student cutting hair."
            ...
            <div className="w-full md:w-2/3 flex flex-col p-10 bg-dark-200 rounded-xl">
                <h2 className="text-4xl font-semibold">Barber Crossover Course</h2>
                <div className="flex justify-between mt-8">
                    ...
                    <div><span className="text-xl font-bold">$2400</span></div>
                </div>
                <div className="flex justify-between mt-8">
                    <div className="flex flex-col">
                        <h3 className="text-xl font-bold">Prerequisite for Crossover Course:</h3>
                        <p className="ml-3">Completed 1600 hours of Cosmetology in an approved California cosmetology school and provide a "Proof of Training" document from the school or provide a California Cosmetology license whether expired or not.</p>
                    </div>
                </div>
...
export default CrossoverCourse
