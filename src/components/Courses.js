...
const Courses = () => {
    return (
        <div className="flex flex-col bg-dark-200 rounded-xl mt-16 p-8 text-center">
            <h1 className="text-5xl font-bold mb-6">Approved Courses</h1>
            <p className="text-xl mx-3 md:mx-0">Courses approved by the Bureau for Private Postsecondary Education</p>
